...
urlpatterns = [
    ...
    path('event_list/', JoadEventListView.as_view(), name='event_list'),
    path('event_registration/<int:event>/', EventRegistrationView.as_view(), name='event_registration'),
    ...
    path('session_list/', SessionListView.as_view(), name='session_list'),
