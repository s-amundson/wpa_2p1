...
class TestsTasks(TestCase):
    ...
    def test_expired_member(self):
        ...
        self.assertFalse(s.user.has_perm('student_app.members'))
    ...
    def test_current_member(self):
        ...
        membership_expire_update()
        s = Student.objects.get(pk=2)
        self.assertTrue(s.user.has_perm('student_app.members'))
    ...
    def test_membership_user_update(self):
        ...
        membership.save()
        self.assertFalse(User.objects.get(pk=2).has_perm('student_app.members'))
        membership_user_update()
        members = Member.objects.all()
        # self.assertEqual(len(members), 2)
        self.assertTrue(User.objects.get(pk=2).has_perm('student_app.members'))