...
class TestsClassAttendance(TestCase):
    ...
    def test_class_attendance(self):
        ...
        response = self.client.get(reverse('registration:beginner_class', kwargs={'beginner_class': 1}))
        ...
        self.client.get(reverse('registration:beginner_class', kwargs={'beginner_class': 1}))
        ...
        self.client.post(reverse('registration:beginner_class', kwargs={'beginner_class': 1}),
                         {'attendee_form': 'on', 'check_2': 'on', 'check_3': 'on'})
