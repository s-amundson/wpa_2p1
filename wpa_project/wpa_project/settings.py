...
EMAIL_ADDRESSES = get_secret('EMAIL_ADDRESSES')
...
FACEBOOK_APP_TOKEN = get_secret('FACEBOOK_APP_TOKEN')
FACEBOOK_PAGE = get_secret('FACEBOOK_PAGE')
FACEBOOK_PAGE_TOKEN = get_secret('FACEBOOK_PAGE_TOKEN')
FACEBOOK_USER_ID = get_secret('FACEBOOK_USER_ID')
FACEBOOK_USER_TOKEN = get_secret('FACEBOOK_USER_TOKEN')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'info.context_processors.policy_list',
